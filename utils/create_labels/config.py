...
LABELS_CVPR_FILE = INPUT_FOLDER.parents[2] / "labels_CVPR.csv"  # Original labels file for reference
LABELS_FILE = INPUT_FOLDER.parents[0] / "labels.csv"  # Original labels file for reference
